...
export function AppSidebar({
  ...
  return (
    <aside className="drawer-side z-40">
      ...
      <div
        className={`flex min-h-full transition-all ${collapsed ? 'w-20 items-center' : 'w-80'} flex-col bg-base-100 p-2 lg:p-4 shadow-xl`}
        title="Project Manager"
      >
        <div
          className={`rounded-box bg-base-200 p-3 w-full flex ${collapsed ? 'items-center justify-center' : 'items-start gap-3'}`}
        >
          {!collapsed && (
            <div
            ...
            <li key={item.to}>
              ...
              >
                <div className={`flex items-center gap-3 ${collapsed ? 'justify-center' : ''}`}>
                  <div className="w-8 h-8 flex items-center justify-center rounded-md font-semibold bg-base-200 text-base-content">
